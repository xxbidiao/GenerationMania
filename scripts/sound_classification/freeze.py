"""Converts a trained checkpoint into a frozen model.

EXAMPLE USAGE:
    python freeze.py --start_checkpoint=train_dir/conv.ckpt-18000 --output_file=pretrained_graph.pb"""
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='piano,synth,bass,guitar,kick,snare,drum,saw,violin,acid,harp,full,fx,rap,cutup,beat,lute,vocal,glitch,hard,hop,marimba,clap,accordion,noise,idm,cymbal',
